...
export const categories: readonly Category[] = [
  {
    slug: "cooling",
    title: "Охолодження",
    tagline: "COOLFRESH™ — до 4 годин комфорту в спеку",
    description:
      "Жилети, бандани та килимки, що працюють за принципом випаровування: намочіть, відіжміть, вдягніть. Температура тіла собаки знижується на 3–5 °C без крижаної води та стресу.",
    accent: "sky",
    glyph: "🧊",
  },
  {
    slug: "apparel",
    title: "Одяг",
    tagline: "Elasto-Fit® — крій, що не сковує рух",
    description:
      "Парки, светри, дощовики та футболки з еластичними вставками. Підходять і для витягнутих порід, і для кремезних — без натирання під пахвами.",
    accent: "accent",
    glyph: "🧥",
  },
  {
    slug: "safety",
    title: "Безпека",
    tagline: "Видимість на дорозі та впевненість на воді",
    description:
      "Рятувальні жилети з ручкою для підйому та світловідбивна амуніція для прогулянок у темну пору доби.",
    accent: "mint",
    glyph: "🦺",
  },
  {
    slug: "accessories",
    title: "Аксесуари",
    tagline: "Дрібниці, які рятують прогулянку",
    description:
      "Снуди, черевики та іграшки, що доповнюють основний гардероб улюбленця.",
    accent: "accent",
    glyph: "🧦",
  },
];
